...
INSERT INTO `popapp_db`.`users` (`roles_id_role`, `events_id_event`, `stores_id_store`, `first_name`, `last_name`,
                                 ...
                                 `is_accepted`, `current_refresh_token`)
VALUES (3, 1, 1, 'Catherine', 'Velasquez', 'cvelasquez@pop.app', 'cvelasquez',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 1000, 1, NULL),
       (1, 1, 1, 'Dayton', 'Huff', 'dhuff@pop.app', 'dhuff',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 300, 1, NULL),
       (1, 1, 1, 'Naomi', 'Morse', 'nmorse@pop.app', 'nmorse',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 300, 1, NULL),
       (1, 1, 2, 'Bruno', 'Hartman', 'bhartman@pop.app', 'bhartman',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 300, 0, NULL),
       ...
       (2, 1, 2, 'Sean', 'Barry', 'sbarry@pop.app', 'sbarry',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 0, 1, NULL),
       (2, 2, 3, 'Olivia', 'Preston', 'opreston@pop.app', 'opreston',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 0, 1, NULL),
       (2, 2, 3, 'Nora', 'Alvarez', 'nalvarez@pop.app', 'nalvarez',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 0, 1, NULL),
       (1, 2, 3, 'Josh', 'Cross', 'jcross@pop.app', 'jcross',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 50, 0, NULL),
       (2, 2, 3, 'Dashawn', 'Cervantes', 'dcervantes@pop.app', 'dcervantes',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 0, 1, NULL),
       (2, 2, 3, 'Jada', 'Padilla', 'jpadilla@pop.app', 'jpadilla',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 0, 1, NULL),
       (1, 2, 3, 'Connor', 'Kaufman', 'ckaufman@pop.app', 'ckaufman',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 70, 0, NULL),
       (2, 2, 3, 'Haven', 'Arroyo', 'harroyo@pop.app', 'harroyo',
        '$2a$10$FfiydZ0lGFvgs288gbAhmeOBaF9h.kfgjmtkJcowuWUTdLB1Tl4gG', CURRENT_TIMESTAMP(), 0, 0, NULL);
